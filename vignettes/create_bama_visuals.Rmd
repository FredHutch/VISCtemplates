...
- `response` a binary outcome based on `magnitude` where a "positive response" (`response = 1`) indicates some threshold for an increase in `magnitude` from the baseline timepoint was met. By definition a baseline timepoint is an `NA`. 
