...
#' @description Compare two data objects from different commits. Ojects are compared through package {diffdf}.
#' @section Last updated by:
#' Valeria Duran
#' @section Last updated date:
#' 01/25/2023
#' @param data_object The data object name. Can be left blank to select from .rda options, typed partially or fully, or can be a data object in current environment.
#' @param SHA1 First commit id. Can be short or long hash. Defaults to NULL (useful for situations where pdata has just been updated and comparison is being done with previous version)
#' @param SHA2 Second commit id. Can be short or long hash. Defaults to NULL (useful when comparing currently loaded data object with most recent commit in SHA1)
