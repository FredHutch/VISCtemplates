...
# same table as above, but using flextable instead of kable (works better for Word output)
magnitude_tab %>%
...
```{r Software-Session-Information-flextable, results="asis"}
# same table, but using flextable instead of kable (works better for Word output)
...
```{r Software-Package-Version-Information-flextable, results="asis"}
# same table, but using flextable instead of kable (works better for Word output)
