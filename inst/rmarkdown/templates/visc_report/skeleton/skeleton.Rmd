...
toc: true
output: 
  VISCtemplates::visc_report: default
...
```{r example-plot, fig.scap = "Shorter caption for table of contents.", fig.cap= "Longer caption that shows under the figure. Explain everything needed to understand the figure here."}
...
if (any(installed.packages()[,1] == 'scharpTemplates')) suppressWarnings(library(VISCtemplates))
