...
packages_needed <- c("conflicted", "tidyverse", "knitr", "flextable", "rprojroot", "remotes")
...
#| tab.id: example-tab
#| tab.cap: "Long caption to show above table. Explain everything needed to understand the table here."

# TODO: figure out how to use caption_short

magnitude_tab <- magnitude_results %>% 
  select(-Population, -contains("Perfect")) 

flextable(magnitude_tab) %>%
  merge_v(1:2) %>%
  add_footer_lines(values = as_paragraph("SD: standard deviation."))
```
...
#| tab.id: Software-Session-Information
#| tab.cap: "Reproducibility software session information"
...
#| tab.id: Software-Package-Version-Information
#| tab.cap: "Reproducibility software package version information"
