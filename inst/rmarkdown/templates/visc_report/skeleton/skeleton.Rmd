...
opts_chunk$set(cache = FALSE, 
               ...
               out.extra = "",
               fig.pos = "H",
               eval.after = c("fig.scap", "fig.cap")) # allows using variables from chunk in figure caption
...
# Table settings
options(knitr.kable.NA = '') # NAs will show as blank
...
source(rprojroot::find_rstudio_root_file("R", "colors_and_shapes.R"), local = TRUE)
```
