...
Pairwise comparisons of response magnitude ([AUTC, MFI*]) between study groups were performed using the Wilcoxon rank-sum test (two-sided, alpha = 0.05) on positive responders only. Tests between study groups required at least [three] positive responders in each treatment group.
