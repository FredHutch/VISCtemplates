...
## Statistical tests
Two-sided 95% confidence intervals ($\alpha$ = 0.05) of positive responders were calculated using Wilson's method [@agresti_approximate_1998].  Response magnitudes were summarized with median, minimum, and maximum.
