...
To be included in the time point comparisons, a participant must be a responder 
in at least one of the time points. 

The Wilcoxon tests are rank-based tests used to account for non-normality in the 
magnitude measurements. Because response magnitude comparisons were performed on 
responders only, each group must have at least 3 responders for the comparison 
to be conducted. 
